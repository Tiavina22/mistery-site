      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            <a href="#acceptance" className="bg-card rounded-xl p-4 hover:bg-secondary transition-colors">
            ...
            <a href="#users" className="bg-card rounded-xl p-4 hover:bg-secondary transition-colors">
            ...
            <a href="#content" className="bg-card rounded-xl p-4 hover:bg-secondary transition-colors">
              <AlertCircle className="w-6 h-6 text-[#1DB954] mb-2" />
              <h3 className="text-foreground font-semibold mb-1">Contenu</h3>
              <p className="text-sm text-muted-foreground">Propriété intellectuelle</p>
            </a>
          </div>
          ...
          <div className="space-y-8">
            {/* Section 1 */}
            <section id="acceptance" className="bg-card rounded-2xl p-8">
            ...
            {/* Section 2 */}
            <section id="users" className="bg-card rounded-2xl p-8">
              <h2 className="text-2xl font-heading font-bold mb-4 text-foreground">
            ...
            {/* Section 3 */}
            <section id="content" className="bg-card rounded-2xl p-8">
              <h2 className="text-2xl font-heading font-bold mb-4 text-foreground">
                3. Contenu et Propriété Intellectuelle
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <h3 className="text-lg font-semibold text-foreground">3.1 Contenu des Créateurs</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-foreground">3.2 Contenu Interdit</h3>
