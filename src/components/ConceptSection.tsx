...
export default function ConceptSection() {
  ...
  return (
    <section id="concept" className="py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold mb-4 lg:mb-6">
            <span className="text-gradient-gold">{t('concept.title')}</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {concepts.map((concept, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-5 group-hover:bg-primary/20 transition-colors">
                  <Icon className="w-6 h-6 lg:w-7 lg:h-7 text-primary" />
                </div>
                
                {/* Content */}
                <h3 className="text-lg lg:text-xl font-heading font-semibold mb-2 group-hover:text-primary transition-colors">
                  {t(concept.titleKey)}
                </h3>
